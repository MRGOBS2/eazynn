<?php
require_once("C:/xampp/htdocs/eazyn/config/connect.php");
...
$run_sql = mysqli_query($is_connect,$query); //jalankan query
?>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <?php
                        ...
                        ?>
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0"><?php echo $data[1] ?></h6></td>
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                      <div class="col-4">
                      <?php
                      $query1 = "select value from setting where setting = 'pembatasan'";
                      $query2 = "select count(id) as jumlah_izin from izin where siswa_id = 1 and is_approved =2";
                      ...
                      //echo "<pre>";var_dump($fetch_data1);
                      ?>
                      <h4 class="fw-semibold mb-3">
                         <strong><?php echo $fetch_data1[0]['value']-$fetch_data2[0]['jumlah_izin']; ?></strong>
                      </h4>
                     </div>
                     <div class="col-4">
